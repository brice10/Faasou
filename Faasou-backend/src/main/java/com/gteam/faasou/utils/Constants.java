...
public class Constants {
	...
	// Context
	public static final String COVID = "COVID", COVID19 = "COVID 19", CORONA_VIRUS = "CORONAVIRUS", PANDEMIE = "PANDEMIE", GEL_HYDROALCOLIQUE = "GEL HYDROALCOLIQUE", CONFINEMENT = "CONFINEMENT";
}
